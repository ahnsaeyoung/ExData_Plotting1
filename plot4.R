...
with(feb_subset, plot(date_time, Global_active_power, type="l", xlab="",ylab="Global Active Power (kilowatts)"))

with(feb_subset, plot(date_time, Voltage, type="l", xlab="",ylab="Voltage"))
...
legend("topright", , bg="transparent", bty="n", legend= c("Sub_metering_1", "Sub_metering_2", "Sub_metering_3"), col=c("black", "red", "blue"), lty=1)


with(feb_subset, plot(date_time, Global_reactive_power, type="l", xlab="",ylab="Global Rective Power (kilowatts)"))
dev.off()   